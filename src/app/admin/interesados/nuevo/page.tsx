...
export default function NuevoInteresadoPage() {
    ...
    const [formData, setFormData] = useState({
        nombre_completo: "",
        telefonos: "", // Now plural and comma separated in input
        emails: "",    // Now plural and comma separated in input
        tipo_operacion: "venta",
        presupuesto_maximo: "",
        dormitorios_minimo: "",
        preferencias_zonas: "", // Comma separated
        observaciones: "",
        notas_internas: "",
        urgencia: "Media",
        estado: "Nuevo"
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!result.success) {
            ...
            setError("Error al guardar el interesado. Inténtalo de nuevo.");
            return;
        }

        setSuccessMsg("¡Interesado guardado correctamente! Redirigiendo al listado...");
        setTimeout(() => {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">Nuevo Interesado</h1>
                    <p className="text-slate-500">Registra un nuevo cliente buscando propiedades.</p>
                </div>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Lo que el cliente ha dicho (prefiere vistas al mar, trabaja en málaga...)"
                                ></textarea>
                            </div>
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Información privada para el agente (presupuesto real mayor, contacto difícil...)"
                                ></textarea>
                            </div>
                        </div>
                    </div>
